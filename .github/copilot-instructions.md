...
- Course: Query: 4 most recent semesters with intelligent detection (checks if next semester has any data)
  - Warmup strategy: Scrapes 4 semesters individually using ScrapeCourses (4 requests per semester, 16 total)
  - Early upload detection: If next semester uploaded early (e.g., Aug with Sep data), uses it immediately
