...
- **Startup**: `NTPU_WARMUP_WAIT` (default: `false`, gates /webhook only), `NTPU_WARMUP_MAX_WAIT` (default: `0` = wait indefinitely; set e.g. `30m` to unblock /webhook after that duration even if warmup is still running)
