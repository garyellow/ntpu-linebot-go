...
| 模組 | 耗時 | 資料量 | 說明 |
|------|------|--------|------|
| **ID** | 25-40 分鐘 | 1-2 萬筆 | 系所代碼、近 4 年學生（110-113 學年） |
| **Contact** | 3-5 分鐘 | 500-1000 筆 | 行政與學術單位聯絡資訊 |
| **Course** | 8-12 分鐘 | 5000-1 萬筆 | 近 3 年課程（U/M/N/P 學制） |
| **總計** | **35-55 分鐘** | **~2.4 萬筆** | |
...
測試環境：Intel i7, 50 Mbps

| 設定 | 總耗時 | 說明 |
|------|--------|------|
| workers=3 | 50-70 分鐘 | 保守，預設值（推薦） |
| workers=5 | 35-50 分鐘 | 平衡 |
| workers=8 | 25-35 分鐘 | 較快，適合離峰時段 |
