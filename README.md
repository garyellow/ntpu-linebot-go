...
| 查詢方式 | 輸入範例 | 說明 |
|---------|---------|------|
| 學號查詢 | `412345678` | 8-9 位數字 |
| 姓名查詢 | `學號 王小明` | 關鍵字：學號/學生/姓名 |
| 系所名稱 | `系名 資工` | 查詢系代碼（含碩博士班）|
| 系代碼 | `系代碼 85` | 查詢系名稱 |
| 學年度 | `學年 112` | 按學年度搜尋 |
| 所有系代碼 | `所有系代碼` | 顯示大學部對照表 |

> **📌 資料範圍**
> - 姓名查詢：日間部大學部 101-113 學年度
> - 學號查詢：94-113 學年度
...
| 查詢方式 | 輸入範例 | 說明 |
|---------|---------|------|
| 課程名稱 | `課程 資料結構` | 關鍵字：課程/老師/教授 |
| 課號查詢 | `U0001` 或 `1131U0001` | 簡碼搜近 2 學期 |
| 智慧搜尋 | `找課 線上實體混合` | 依課程大綱內容匹配 |
| 歷史課程 | `課程 110 微積分` | 指定學年度（90-目前）|
| 更多學期 | `更多學期 微積分` | 擴展搜尋第 3-4 學期 |
