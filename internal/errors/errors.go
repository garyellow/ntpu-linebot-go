...
// IsRateLimitExceeded checks if an error is ErrRateLimitExceeded.
...
// IsCacheExpired checks if an error is ErrCacheExpired.
...
// IsContextCanceled checks if an error is ErrContextCanceled.
func IsContextCanceled(err error) bool {
	return errors.Is(err, ErrContextCanceled)
}

// IsMissingParameter checks if an error is ErrMissingParameter.
func IsMissingParameter(err error) bool {
	return errors.Is(err, ErrMissingParameter)
}

// IsUnknownIntent checks if an error is ErrUnknownIntent.
