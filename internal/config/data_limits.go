...
//   - 「數位學苑 2.0 已於 113 學年度起停用」 (113 年資料極不完整，114 年起完全無資料)
//   - Data ranges: 學年度查詢 94-112 (完整), 113 (極不完整); 姓名查詢 101-112 (完整), 113 (極不完整)
//
...
const (
	...
	// ID113YearWarningMessage is the warning shown before querying year 113.
	// Informs users that data is sparse but allows them to proceed.
	ID113YearWarningMessage = "⚠️ 113 學年度資料極不完整\n\n" +
		"113 學年度起新生使用 LMS 3.0，僅少數學生有建立 LMS 2.0 帳號。\n\n" +
		"查詢結果可能：\n" +
		"• 無任何資料\n" +
		"• 僅顯示極少數學生\n\n" +
		"💡 建議查詢 94-112 學年度以獲得完整資料"
