	...
	tests := []struct {
		...
		// S3-compatible snapshot tests
		{
			...
			cfg: &Config{
				...
				S3BucketName:           "bucket",
				S3SecretKey:            "secret",
				S3SnapshotKey:          "snapshots/cache.db.zst",
				S3LockKey:              "locks/leader.json",
				S3LockTTL:              time.Hour,
				S3SnapshotPollInterval: 5 * time.Minute,
				S3DeltaPrefix:          "deltas",
				S3ScheduleKey:          "schedules/maintenance.json",
			},
			wantErr:     true,
			errContains: "NTPU_S3_ACCESS_KEY_ID",
		},
		{
			name: "S3 valid",
			cfg: &Config{
		...
		{
			name: "S3 valid with local endpoint",
			cfg: &Config{
				LineChannelToken:           "token",
				LineChannelSecret:          "secret",
				Port:                       "10000",
		...
		{
			name: "S3 enabled but missing endpoint",
			cfg: &Config{
				LineChannelToken:           "token",
				LineChannelSecret:          "secret",
				Port:                       "10000",
			...
			wantErr:     true,
			errContains: "NTPU_S3_ENDPOINT",
		},
		{
			name: "S3 enabled but invalid endpoint",
			cfg: &Config{
				LineChannelToken:           "token",
				LineChannelSecret:          "secret",
				Port:                       "10000",
		...
		{
			name: "S3 enabled but empty delta prefix",
			cfg: &Config{
				LineChannelToken:           "token",
				LineChannelSecret:          "secret",
				Port:                       "10000",
			...
			wantErr:     true,
			errContains: "NTPU_S3_DELTA_PREFIX",
		},
		{
			name: "S3 enabled but empty schedule key",
			cfg: &Config{
				LineChannelToken:           "token",
				LineChannelSecret:          "secret",
				Port:                       "10000",
			...
			wantErr:     true,
			errContains: "NTPU_S3_SCHEDULE_KEY",
		},
		{
			name: "S3 enabled but lock TTL below renew minimum",
			cfg: &Config{
				LineChannelToken:           "token",
				LineChannelSecret:          "secret",
				Port:                       "10000",
				...
				S3SnapshotKey:              "snapshots/cache.db.zst",
				S3LockKey:                  "locks/leader.json",
				S3LockTTL:                  10 * time.Second,
				S3SnapshotPollInterval:     5 * time.Minute,
				S3DeltaPrefix:              "deltas",
				S3ScheduleKey:              "schedules/maintenance.json",
			},
			wantErr:     true,
			errContains: "NTPU_S3_LOCK_TTL",
		},
		{
			name: "S3 disabled with empty fields",
			cfg: &Config{
				LineChannelToken:           "token",
				LineChannelSecret:          "secret",
				Port:                       "10000",
		...
		{
			name: "S3 enabled but empty snapshot key",
			cfg: &Config{
				LineChannelToken:           "token",
				LineChannelSecret:          "secret",
				Port:                       "10000",
			...
			wantErr:     true,
			errContains: "NTPU_S3_SNAPSHOT_KEY",
		},
		{
...
func TestConfig_FeatureEnabled(t *testing.T) {
	...
	tests := []struct {
		...
		// S3-compatible snapshot sync
		{"S3 disabled", &Config{}, func(c *Config) bool { return c.IsS3Enabled() }, false, "IsS3Enabled"},
		{"S3 enabled", &Config{S3Enabled: true}, func(c *Config) bool { return c.IsS3Enabled() }, true, "IsS3Enabled"},
